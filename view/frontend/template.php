...
<head>
    ...
    <script src="node_modules/tinymce/tinymce.js/tinymce.min.js" type="text/javascript"></script>
    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                ...
                <li role="presentation" class="nav-item"><a class="nav-link" href="index.php?action=listComments">Commentaires</a>
                </li>
            </ul>
            <a class="btn btn-primary bg-primary border-primary text-left ml-auto" type="button"
